...
const LandingPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Upptäck slumpmässiga drinkar och cocktails. Spara dina favoriter och hitta nya recept!" />
      </Helmet>
  ...
  {error && <p className="error-text">{error}</p>}
      ...
      <Button onClick={fetchRandomCocktail} disabled={loading}>
        Hämta ny slumpad cocktail <span role="img" aria-label="tärning" className="landing-dice">🎲</span>
      </Button>
    </>
  );
}
