...
import { coconutVariants } from './svg/closedCoconutVariants';
import { useCoconutContext } from './context/useCoconutContext';
...
const CoconutPile: React.FC = () => {
  ...
  window.dropCoconut = dropCoconut;
        ...
        return (
          <span
            ...
            style={{
              ...
              bottom: `${2 + coco.y}px`, // Lower coconuts
              zIndex: 40 + i,
