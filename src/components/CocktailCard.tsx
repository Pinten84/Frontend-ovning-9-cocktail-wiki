...
const CocktailCard: React.FC<Props> = ({
  ...
  <div className="cocktail-card">
    <Link
      ...
      aria-label={`Visa mer info om ${name}`}
    >
      <img src={thumbnail} alt={name} className="cocktail-card-img" loading="lazy" />
    ...
    >
      Mer info{' '}
      <span role="img" aria-label="drink" className="cocktail-card-drinkicon">
        🍸
      </span>
    </button>
    {buttonText && (
